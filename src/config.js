...
export const FOG_COLOR = 0x87b7d4;

export const TRAIN_COLORS = [0xff5252, 0xffd54f, 0x40c4ff, 0x69f0ae, 0xff8a65];
export const BUILDING_COLORS = [0x5c6bc0, 0xec407a, 0x26a69a, 0xff7043, 0x7e57c2, 0x42a5f5];
